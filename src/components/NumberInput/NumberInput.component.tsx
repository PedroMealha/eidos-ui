...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>(
  (
    ...
    const rootClasses = [
      ...
      fullWidth && 'eidos-number-input--full-width',
    ...
    return (
      <div className={rootClasses}>
        {label && (
          <label htmlFor={allowTyping ? inputId : undefined} className="eidos-number-input-label">
            {label}
          </label>
        )}
        ...
        >
          ...
          {allowTyping ? (
            ...
            <span className="eidos-number-input-display" aria-hidden="true">
