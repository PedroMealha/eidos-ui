...
import { Download, Plus, Trash2, AlignLeft, AlignCenter, AlignRight, List, LayoutGrid } from 'lucide-react';
...
export const Filled: Story = {
	...
	render: () => (
		<ButtonGroup variant="filled" color="primary">
			...
			<Button preIcon={Trash2} color="danger">Delete</Button>
		</ButtonGroup>
	),
};
...
export const IconOnly: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: 'Works with icon-only buttons. Useful for view-switcher or text-formatting toolbars.',
			},
		},
	},
	render: () => (
...
export const PerChildOverride: Story = {
	...
	render: () => (
		<ButtonGroup variant="outlined" color="primary">
			...
			<Button variant="filled" color="danger" preIcon={Trash2}>Delete</Button>
		</ButtonGroup>
	),
};
