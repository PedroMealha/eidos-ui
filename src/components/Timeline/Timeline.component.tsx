...
export const Timeline: React.FC<TimelineProps> = ({ items, className = '' }) => (
  <ol className={['eidos-timeline', className].filter(Boolean).join(' ')} aria-label="Timeline">
      ...
      return (
        ...
        >
          ...
          <div className="eidos-timeline-content">
            ...
            {item.description && <p className="eidos-timeline-description">{item.description}</p>}
          </div>
        </li>
      );
    })}
