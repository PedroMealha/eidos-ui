...
const SAVE_OPTIONS = [
	{ id: 'draft',    label: 'Save as draft',    icon: FileText, onClick: () => console.log('Save as draft') },
	{ id: 'template', label: 'Save as template', icon: Save,     onClick: () => console.log('Save as template') },
	{ id: 'schedule', label: 'Schedule publish', icon: Clock,    onClick: () => console.log('Schedule') },
];
