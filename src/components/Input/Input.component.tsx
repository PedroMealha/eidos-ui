...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const inputClasses = [
      ...
      `eidos-input--${color}`,
      `eidos-input--${size}`,
      fullWidth && 'eidos-input--full-width',
    ...
    const wrapperClasses = [
      ...
      fullWidth && 'eidos-input-wrapper--full-width',
    ...
    return (
      <div
        className={`eidos-input-container ${fullWidth ? 'eidos-input-container--full-width' : ''} ${className}`}
